...
public class IngredientServiceImplTest {
    ...
    public void findByRecipeIdAndReceipeIdHappyPath() throws Exception {
        ...
        //then
        IngredientCommand updatedIngredientCommand
                = ingredientService.findByRecipeIdAndIngredientId("1", "3")
                .block();

        //when
        assertEquals("3", updatedIngredientCommand.getId());
    ...
    public void testSaveRecipeCommand() throws Exception {
        ...
        unitOfMeasure.setDescription("blablabla");
        unitOfMeasure.setId("asbfnwqdi109jansnd");
